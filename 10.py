...
cl = LINETCR.LINE() #A
cl.login(token="EnLIkiLNonIKsaF93Tp3.sb64BGZdEL0gc+6NjGPCqW.J2hS3U1xDxt8BCMcZJmPcMO3pVRGKQGSG20pT+Wfaag=")
...
# ----------------- NOTIFED MEMBER JOIN GROUP
        ...
        if op.type == 26:
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["B ourl","B link on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["C ourl","C link on"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["D ourl","D link on"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["B curl","B link off"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["C curl","C link off"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["D curl","D link off"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
                ...
                if len(string.decode('utf-8')) <= 500:
                 ...
                 if msg.toType == 2:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Yang melihat\n____________________________%s\n\nMelihat ga chat\n\n%s\n\n===========================\nIn the last seen point:\n[%s]\n===========================\n" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        print "\nReading Point Set..."
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        ...
                        wait2['ROM'][msg.to] = {}
                        print "lukers"
                        cl.sendText(msg.to, "Auto reset aktif")
                    else:
                        cl.sendText(msg.to, "Ketik Lurk terlebih dahulu")
