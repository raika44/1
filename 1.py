...
cl = LINETCR.LINE() #A)
cl.login(token="Enm3TBHxSxeWqS8qwGl2.WCCRkMNgQXINSOQNF/5yiG.5Q1Z3+cv7n6lRiTDINwLyHL9BCjrMiIKENp4YnzT4KI=")
                ...
                if mid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            kc.inviteIntoGroup(op.param2,[op.param1])
                        except:
                ...
                if len(string.decode('utf-8')) <= 500:
                 ...
                 if msg.toType == 2:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        wait2['ROM'][msg.to] = {}
                        print "lukers"
                        cl.sendText(msg.to, "reset aktif")
                    else:
